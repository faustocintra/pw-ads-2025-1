...
/*
    Quando o nome das propriedades é idêntico ao das variáveis que lhes darão os valores,
    é possível usar a sintaxe chamada PROPRIEDADES ABREVIADAS, pela qual não é necessário
    repetir os nomes das variáveis à frente do nome das propriedades
*/
const user2 = {
    fullname,
    username,
...
/*
    Exibindo o valor das duas variáveis com console.log().
     Observe que os valores são mostrados, masa a saída não informa
...
/*
    ...
    como propriedade abreviadas para o console.log(), conseguimos
